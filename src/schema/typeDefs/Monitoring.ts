/**
 * ==========================================
 * MONITORING GRAPHQL TYPE DEFINITIONS
 * ==========================================
 *
 * Schema GraphQL untuk fitur monitoring penggunaan air.
 *
 * Queries yang tersedia:
 * - monitoringDashboard: Data lengkap dashboard monitoring
 * - monitoringHistory: Riwayat penggunaan beberapa bulan
 * - monitoringHourly: Data per jam untuk tanggal tertentu
 */

export const monitoringTypeDefs = `
  # ==========================================
  # TYPE DEFINITIONS
  # ==========================================
